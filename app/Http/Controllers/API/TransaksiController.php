...
;
    ...
    {
        $transaksi = Transaksi::where('user_id', $user_id)->with('user','kendaraan.kategori','kendaraan.user','pengemudiTransaksi','belum_rating')->with('kendaraan.avgRating')->where('status','Proses')->get();
    ...
    {
        $transaksi = Transaksi::where('user_id', $user_id)->with('user','kendaraan.kategori','kendaraan.user','pengemudiTransaksi','ratingKendaraan','belum_rating')->with('kendaraan.avgRating')->where('status','Selesai')->get();
