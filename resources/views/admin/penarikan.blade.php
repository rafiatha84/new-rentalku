            ...
            <table class="table table-sm" id="table-pengguna">
              ...
              <tbody>
                <tr>
                  ...
                  <td>500.231</td>
                  <td>
                    <button type="button" class="edit-button px-3 py-1">Transfer</button>
                  </td>
                  <td>
                      <i class="color-base-second">Pengajuan</i> <i class="fa-solid fa-info-circle" onclick="show_detail(1)"></i>
                  </td>
                </tr>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-body">
                  ...
                  <input type="text" name="" id="" value="Bank BCA" class="input-form w-100 p-2">
                  <p class="m-0">No. Rekening</p>
                  <input type="text" name="" id="" value="32768279" class="input-form w-100 p-2">
                  </div>
                  <form action='' id="formdelete" method="get">
                  </form>
              </div>
