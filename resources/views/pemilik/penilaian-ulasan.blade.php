        ...
        <div class="container">
            <div class="row col-12">
                <div class="detail-box col-8 offset-2 mt-5 p-0 pb-4">
                    ...
                    <h5 class="d-inline">{{ number_format($pemilik->rating_user_avg_jumlah_bintang,1) }}</h5> <p class="d-inline">dari {{$pemilik->ratingUser->count() }} Ulasan</p>
                        <p>
                            <?php 
                                $bintangactive = (int)$pemilik->rating_user_avg_jumlah_bintang;
                        ...
                        @if($pemilik->ratingUser->count() > 0)
                            @foreach($pemilik->ratingUser as $rating)
                            <div class="row">
