                            ...
                            <td class="aksi-column">
                                <div class="row col-12">
                                    <div class="col-6 text-center px-1">
                                        <a href="{{ route('user.pemesanan.detail',$transaksi->id) }}" class=" button-yellow-secondary p-2 d-block w-100 border-radius-5px" >Lihat Detail<br>Pemesanan</a>
                                    </div>
                                    <div class="col-6 text-center">
                                        @if($transaksi->belum_rating())
                                            <button class="href-base button-yellow-primary p-2 d-block w-100 border-radius-5px" onclick="show_review({{$transaksi->id}})"><div class="d-flex justify-content-center">
                                                <div class="spinner-border" role="status">
                                                    <span class="sr-only">Proses...</span>
                                                </div>
                                            </div>
                                            Beri<br>Nilai</button>
                                        @else
                                        <a href="{{ route('user.pemesanan.create',$transaksi->kendaraan->id) }}" class="button-yellow-primary p-2 d-block w-100 border-radius-5px">Pesan<br>Lagi</a>
                                        @endif
                                    </div>
                                </div>
                            </td>
