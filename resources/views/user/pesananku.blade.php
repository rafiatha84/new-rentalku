                            ...
                            <td class="aksi-column">
                                <div class="row col-12">
                                    <div class="col-6 text-center px-1">
                                        <a href="{{ route('user.pemesanan.detail',$transaksi->id) }}" class=" button-yellow-secondary p-2 d-block w-100 border-radius-5px" >Lihat Data<br>Pemesanan</a>
                                    </div>
                                    <div class="col-6 text-center px-1">
                                        <button class="href-base button-yellow-primary p-2 d-block w-100 border-radius-5px" onclick="show_room()">Hubungi<br>Pemilik Mobil</button>
                                    </div>
                                </div>
                            </td>
                        </tr>
