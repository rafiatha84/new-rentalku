            ...
            <div class="profile-box mx-auto col-6 p-4">
                ...
                <div class="row col-12">
                    ...
                    <div class="col-6 offset-3">
                        ...
                        <input type="password" name="" id="" class="d-block w-100 input-style px-2 py-3" placeholder="Masukkan Password Lama">
                    </div>
                    <div class="col-6 offset-3">
                        <label for="" class="mb-0">Password Baru</label>
                        <input type="password" name="" id="" class="d-block w-100 input-style px-2 py-3" placeholder="Masukkan Password Baru">
                    </div>
                    <div class="col-6 offset-3">
                    ...
                    <div class="col-6 offset-3 mt-4">
                        <a href="{{ route('user.profile') }}" class="btn d-block w-100 button-base-secondary px-2 py-2">Simpan</a>
                    </div>
                </div>
            </div>
